...
В [`packwiz/pack.toml`](packwiz/pack.toml) зафиксированы все **фактически установленные JAR-моды**: Craftoria 1.37.0, Minecraft 1.21.1, NeoForge 21.1.249, 533 мода. В манифест также входят 35 штатных ресурспаков и 3 шейдерпака Craftoria; личные дополнения вроде Faithful не включены. Среди добавленных модов — Baritone, Create: New Age, Vein Mining и наш CompassHUD. Версии модов автоматически не повышаются.

Инструкция по подключению в Prism Launcher и поддержке манифеста: [PACKWIZ.md](PACKWIZ.md). Этот манифест предназначен для **клиентов**, а не для прямой установки на сервер.
